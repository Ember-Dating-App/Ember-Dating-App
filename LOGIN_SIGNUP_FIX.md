...
### Technical Details:
- Frontend `.env` file contains: `REACT_APP_BACKEND_URL=https://datenight-app-1.preview.emergentagent.com`
...
// Resolves to: https://datenight-app-1.preview.emergentagent.com/api/auth/login
```
...
### Backend URL:
```
https://datenight-app-1.preview.emergentagent.com/api
```
...
External URL: https://datenight-app-1.preview.emergentagent.com
API Prefix: /api
```
