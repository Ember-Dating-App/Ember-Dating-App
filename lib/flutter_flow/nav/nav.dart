...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
            ...
            builder: (context, params) => params.isEmpty
                ...
                : NavBarPage(
                    ...
                    page: MessagesPageWidget(),
                  )),
        FFRoute(
            name: ProfileHomePageWidget.routeName,
            path: ProfileHomePageWidget.routePath,
            builder: (context, params) => params.isEmpty
                ? NavBarPage(initialPage: 'ProfileHomePage')
                : NavBarPage(
                    initialPage: 'ProfileHomePage',
                    page: ProfileHomePageWidget(),
                  )),
        FFRoute(
        ...
        FFRoute(
            name: DatingTipsPageWidget.routeName,
            path: DatingTipsPageWidget.routePath,
            builder: (context, params) => params.isEmpty
                ? NavBarPage(initialPage: 'DatingTipsPage')
                : NavBarPage(
                    initialPage: 'DatingTipsPage',
                    page: DatingTipsPageWidget(),
                  )),
        FFRoute(
        ...
        FFRoute(
          name: FiltersPageWidget.routeName,
          path: FiltersPageWidget.routePath,
