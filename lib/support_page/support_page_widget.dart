                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        ...
                        if (selectedMedia != null &&
                          ...
                          safeSetState(() =>
                              _model.isDataUploading_uploadDataPw0 = true);
                          ...
                          try {
                            ...
                            _model.isDataUploading_uploadDataPw0 = false;
                          }
                          if (selectedUploadedFiles.length ==
                                  selectedMedia.length &&
                              downloadUrls.length == selectedMedia.length) {
                            safeSetState(() {
                              _model.uploadedLocalFile_uploadDataPw0 =
                                  selectedUploadedFiles.first;
                              _model.uploadedFileUrl_uploadDataPw0 =
                                  downloadUrls.first;
                            });
                          } else {
                            safeSetState(() {});
