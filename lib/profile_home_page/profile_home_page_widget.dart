...
class ProfileHomePageWidget extends StatefulWidget {
  const ProfileHomePageWidget({super.key});

  static String routeName = 'ProfileHomePage';
  static String routePath = '/profileHomePage';

  @override
  State<ProfileHomePageWidget> createState() => _ProfileHomePageWidgetState();
}
          ...
          children: [
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        height: 141.97,
                        decoration: BoxDecoration(
                          color: Color(0x00F88A47),
                          shape: BoxShape.circle,
                          border: Border.all(
                            color: Color(0x00F87838),
                            width: 2.0,
                          ),
                        ),
                        child: ClipRRect(
            ...
            Padding(
              ...
              child: InkWell(
                ...
                onTap: () async {
                  context.pushNamed(CreateProfilePageWidget.routeName);
                },
                child: Container(
                  width: double.infinity,
                  height: 60.0,
            ...
            Padding(
              ...
              child: InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  context.pushNamed(NotificationSettingsPageWidget.routeName);
                },
                child: Container(
                  width: double.infinity,
                  height: 60.0,
            ...
            Align(
              ...
              child: Padding(
                ...
                child: InkWell(
                  ...
                  highlightColor: Colors.transparent,
                  onTap: () async {
                    context.pushNamed(TermsofServicePageWidget.routeName);
                  },
                  child: Container(
                    width: double.infinity,
                    height: 60.0,
              ...
              child: Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    context.goNamedAuth(
                        CreateAccountPageWidget.routeName, context.mounted);
                  },
                  text: 'Log Out',
